var CostiConsumi = {
	...
	htmlContent : {
		...
		"<div id='CostoSintesi'><img id='CostoSintesiBg' src='" + Define.home["sfondo_sx"] + "'>" +
		...
		"<div id='CostoInfo'><img id='CostoInfoBg' src='" + Define.home["sfondo_dx"] + "'>" +
		...
		"<div id='CostoSuggerimento'><img src='" + Define.home["sfondoSugg"] + "' id='SuggerimentoImg'>" +
		"<div id='CostoFumettoDiv'><img src='' id='CostoFumettoImg'></div><span id='CostoTitoloSuggerimento'>" + Msg.home["suggerimenti"] + "</span>" + 
		"<div id='DettaglioSuggerimentiCosti'></div></div>",

		"Consumi" : 
			"<div id='TitoloConsumi' class='ContentTitle'>"	+ Msg.home["consumi"] + "</div>" + 
			"<div id='ConsumoSintesi'><img id='ConsumoSintesiBg' src='" + Define.home["sfondo_sx"] + "'>"  + 
			"<div id='ConsumoAttualeTitolo' class='TitoloDettaglio'>" + Msg.home["titoloConsumi"] + "</div>" + 
			"<div id='ConsumoAttuale'><span id='ValConsumoAttuale'></span><div id='ConsumoAttualeMeter'></div></div>" +
			"<div id='ConsumoOdierno'><span id='DettaglioConsumoOdierno'></span></div>" +
			"<div id='ConsumoPrevisto'><span id='DettaglioConsumoPrevisto'></span></div>" +
			...
			"<div id='ConsumoInfo'><img id='ConsumoInfoBg' src='" + Define.home["sfondo_dx"] + "'>"  +
			...
			//"<div id='DettaglioConsumoMaggiore'><span id='TestoConsumoMaggiore'></span><img id='ConsumoMaggioreImg' src=''></div></div>" + 
			"<div id='DettaglioConsumoMaggiore'></div></div>" +
			"<div id='ConsumoSuggerimento'><img src='" + Define.home["sfondoSugg"] + "' id='SuggerimentoImg'>" +
			"<div id='ConsumoFumettoDiv'><img src='' id='ConsumoFumettoImg'></div><span id='ConsumoTitoloSuggerimento'>" + Msg.home["suggerimenti"] + "</span>" + 
...
CostiConsumi.ExitCostiVuoto = function() {
	Log.alert(80, CostiConsumi.MODULE, "CostiConsumi.ExitCostiVuoto");
	$("#Content").html(null);
	//hideSpinner();
}

CostiConsumi.GestCostiVuoto = function() {
	Log.alert(80, CostiConsumi.MODULE, "CostiConsumi.GestCostiVuoto");
	$("#Content").html(CostiConsumi.htmlContent["CostiVuoto"]);
}
...
CostiConsumi.VisSuggerimento = function(divSuggerimento) {
	...
	if (testo != null) {
		...
		if (testo.indexOf("<br>") != -1) {
			...
			$(divSuggerimento).css("padding-top", "8%");
			$(divSuggerimento).css("font-size", "0.9em");
		}
...
CostiConsumi.VisCosti = function() {
	...
	if (CostiConsumi.suggerimento != null)
		CostiConsumi.VisSuggerimento("#DettaglioSuggerimentiCosti");
