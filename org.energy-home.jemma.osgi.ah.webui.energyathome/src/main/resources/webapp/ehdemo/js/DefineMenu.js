	...
	var DefineMenu = [ {"Nome" : Msg.menu["home"],
						...
						"SubMenu": [{"Nome" : Msg.menu["fv"],
									...
									{"Nome" : Msg.menu["consumi"], //Msg.menu["costi"],
									 ...
									 "Section": Tracing.CONSUMPTIONS,
									 "FuncEnter" : "LazyScript.load('js/CostiConsumi3.js?n=201304091118',function(){CostiConsumi.GestConsumi();})", //"LazyScript.load('js/CostiConsumi2.js',function(){CostiConsumi.GestCosti();})",
									...
									{"Nome" : Msg.menu["dispositivi"],
									 ...
									 "FuncEnter" : "LazyScript.load('js/Elettrodomestici.js?n=201304091118',function(){ Elettrodomestici.GestElettrodomestici();})",
									...
									{"Nome" : Msg.menu["storico"],
									 ...
									 "FuncEnter" : "LazyScript.load('js/Storico.js?n=201304091118',function(){Storico.GestStorico();})",
									...
									{"Nome" : Msg.menu["report"],
									 ...
									 /*
									 "FuncEnter" : "LazyScript.load('js/Report.js?n=201304091118',function(){Report.Init();})",
									 "FuncExit": "Report.Exit()"
									 */
					   ...
					   {"Nome" : Msg.menu["config"],
						...
						"SubMenu": [{"Nome" : Msg.menu["registrazione"],
									 "Image" : Define.menu["questionari"],
									 "ImageSelected" : Define.menu["questionariSel"],
									 "FuncEnter" : "LazyScript.load('js/registrazione.js?n=201304091118',function(){Registrazione.Init();})",
									...
									{"Nome" : Msg.menu["opzioniLocal"],
									 ...
									 "Section": Tracing.HISTORY,
									 /*
									 "FuncEnter" : "LazyScript.load('js/OpzioniLocal.js?n=201304091118',function(){OpzioniLocal.GestOpzioniLocal();})",
									 "FuncExit": "OpzioniLocal.ExitOpzioniLocal()"
									 */
									 "FuncEnter" : "NonDisponibile.GestND()",
									 "FuncExit": "NonDisponibile.ExitND()"}]},
					   {"Nome" : Msg.menu["community"],
						...
						"SubMenu": [{"Nome" : Msg.menu["forum"],
									 ...
									 "FuncEnter" : "LazyScript.load('js/Community.js?n=201304091118',function(){Community.GestForum();})",
					   ...
					   {"Nome" : Msg.menu["infotrial"],
						...
						"SubMenu": [{"Nome" : Msg.menu["tariffa"],
									 ...
									 "FuncEnter" : "LazyScript.load('js/Trial.js?n=201304091118',function(){Trial.GestTariffa();})",
	...
	var DefineMenu = [ {"Nome" : Msg.menu["home"],
						...
						"SubMenu": [{"Nome" : Msg.menu["consumi"],
									...
									{"Nome" : Msg.menu["costi"],
									 ...
									 "FuncEnter" : "LazyScript.load('js/CostiConsumi2.js?n=201304091118',function(){CostiConsumi.GestCosti();})",
									...
									{"Nome" : Msg.menu["report"],
									 ...
									 "Section": Tracing.FORMS,
									 /*
									 "FuncEnter" : "LazyScript.load('js/Report.js',function(){Report.Init();})",
									 "FuncExit": "Report.Exit()"}
									 */
									 "FuncEnter" : "NonDisponibile.GestND()",
									 "FuncExit": "NonDisponibile.ExitND()"}]},
