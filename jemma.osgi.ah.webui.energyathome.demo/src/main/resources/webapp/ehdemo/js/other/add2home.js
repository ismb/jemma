...
function orientationchange(orientation) {
	console.log("orientation is changed to " + orientation);
	...
	var left = isIPad ? startX + (OSVersion >=5 ? 180 : 265) - Math.round(el.offsetWidth/2) : startX;
	if (orient == 'landscape') {
		left -= 68;
	}
