...
Menu.Init = function(mainDiv, contentDiv) {
	...
	Menu.MainHtml = "";
	for (i = 0; i < num; i++) {
		Menu.MainHtml  += "<img id='MainElSfondo' src='" + Menu.sfondoElImg + "' style='position:absolute;top:" + topOffset + "px;left:" + leftOffset + "px;z-index:100;' + width='" + dim + "px' + height='" + dim + "px'>"
