...
public class ZclIASZoneClient extends ZclServiceCluster implements ZigBeeDeviceListener, IASZoneClient {

	public final static short CLUSTER_ID = 1280;

	public ZclIASZoneClient() throws ApplianceException {
		super();
	}
