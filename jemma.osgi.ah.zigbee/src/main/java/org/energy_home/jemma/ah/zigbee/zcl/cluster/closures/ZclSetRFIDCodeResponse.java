...
public class ZclSetRFIDCodeResponse {
    ...
    public static SetRFIDCodeResponse zclParse(IZclFrame zclFrame)
    ...
    public static void zclSerialize(IZclFrame zclFrame, SetRFIDCodeResponse r)
        throws ZclValidationException
    {
        ZclDataTypeUI8 .zclSerialize(zclFrame, r.Status);
    }

    public static int zclSize(SetRFIDCodeResponse r)
        throws ZclValidationException
    {
        int size = 0;
