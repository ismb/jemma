...
public class ZclClearHolidayScheduleResponse {
    ...
    public static ClearHolidayScheduleResponse zclParse(IZclFrame zclFrame)
    ...
    public static void zclSerialize(IZclFrame zclFrame, ClearHolidayScheduleResponse r)
        throws ZclValidationException
    {
        ZclDataTypeUI8 .zclSerialize(zclFrame, r.Status);
    }

    public static int zclSize(ClearHolidayScheduleResponse r)
        throws ZclValidationException
    {
        int size = 0;
