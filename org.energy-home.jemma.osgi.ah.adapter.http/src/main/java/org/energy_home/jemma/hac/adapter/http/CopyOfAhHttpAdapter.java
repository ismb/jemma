...
public class CopyOfAhHttpAdapter implements EventHandler, HttpServletBinder, HttpImplementor {
	...
	protected final static Log log = LogFactory.getLog(CopyOfAhHttpAdapter.class);

	private CustomJsonServlet customJSONServlet;

	private HttpImplementor implementor = null;

	public CopyOfAhHttpAdapter(HttpImplementor implementor) {
		this.implementor = implementor;
	}
	
	public CopyOfAhHttpAdapter(HttpImplementor implementor, String alias) {
		this.implementor = implementor;
		String separator = "";
		if (!alias.endsWith("/")) {
			separator = "/";
