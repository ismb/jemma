...
import org.energy_home.jemma.ah.hac.lib.internal.IEndPointRequestContextCheck;

public class ServiceClusterProxyHandler implements InvocationHandler  {
	...
	private IEndPointRequestContextCheck contextCheck = null;
	...
	public ServiceClusterProxyHandler(IServiceCluster serviceCluster) {
		this.serviceCluster = serviceCluster;
		initServiceClusterImpl();
	}
	
	public ServiceClusterProxyHandler(Object clusterInterfaceImpl, Class clusterInterfaceClass) throws ApplianceException {
		this.serviceCluster = new ServiceCluster(clusterInterfaceImpl, clusterInterfaceClass);
		initServiceClusterImpl();
	}

	public ServiceClusterProxyHandler(Object clusterInterfaceImpl, Class clusterInterfaceClass, IEndPointRequestContextCheck contextCheck) throws ApplianceException {
		this.serviceCluster = new ServiceCluster(clusterInterfaceImpl, clusterInterfaceClass);
		initServiceClusterImpl();
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable { 
		try {
			if (contextCheck != null && args != null && args.length > 0 
					&& args[args.length-1] instanceof IEndPointRequestContext)
					contextCheck.checkRequestContext((IEndPointRequestContext)args[args.length-1]);
