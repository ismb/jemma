...
{$body.click(function(e){var $el=$(e.target);if($el.attr('nodeName')!=='A'&&$el.attr('nodeName')!=='AREA'&&$el.attr('nodeName')!=='INPUT'){$el=$el.closest('a, area');}
...
else if(hash&&hash!='#'){$('.active').removeClass('active');$el.addClass('active');goTo($(hash).data('referrer',$el),animation,$(this).hasClass('reverse'));}else{$el.addClass('loading active');showPageByHref($el.attr('href'),{animation:animation,callback:function(){$el.removeClass('loading');setTimeout($.fn.unselect,250,$el);},$referrer:$el});}
return false;}
...
$.fn.makeActive=function(){$('.active').removeClass('active');return $(this).addClass('active');}
