...
CostiConsumi.GestConsumi = function() {
	...
	if ((CostiConsumi.mode == CostiConsumi.COSTI) || (CostiConsumi.mode == CostiConsumi.FOTOVOLTAICO)) {
		...
		if (Main.enablePV){
			...
			$("#Indicatore").css('top', '0%').css('left', '55%');
			$("#Indicatore").width('17%').height('150%');

			$('#ConsumoIndicatoreImg').css('top', '10%').width('80%');
			$("#IndicatoreSopra").css('top', '10%');
			$("#IndicatoreMedia").css('top', '30%');
			$("#IndicatoreSotto").css('top', '60%');
			$("#IndicatorePaddingLeft").css('top', '10%');
