...
public interface IdentifyServer {

	final static String ATTR_IdentifyTime_NAME = "IdentifyTime";
	final static String CMD_Identify_NAME = "Identify";
	final static String CMD_IdentifyQuery_NAME = "IdentifyQuery";
