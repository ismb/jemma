...
public interface ThermostatServer {

	final static String ATTR_LocalTemperature_NAME = "LocalTemperature";
	final static String ATTR_MinCoolSetpointLimit_NAME = "MinCoolSetpointLimit";
