...
public class PlatformsUtil {
	...
	public static String replace(String str) {
		...
		str = replaceFirst(str, "%os", os);
		str = replaceFirst(str, "%arch", arch);
		return str;
	}

	public static String replaceFirst(String str, String s, String c) {
		int index = str.indexOf(s);
		if (index >= 0) {
			// found
			return str.substring(0, index) + c + str.substring(index + s.length());
		}
		return str;
	}
}
