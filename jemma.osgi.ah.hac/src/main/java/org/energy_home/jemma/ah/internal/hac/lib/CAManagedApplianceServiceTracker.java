...
public class CAManagedApplianceServiceTracker extends ServiceTracker {

	private ConnectionAdminService caService;

	public CAManagedApplianceServiceTracker(BundleContext bc, ConnectionAdminService caService) {
	...
	public Object addingService(ServiceReference sr) {
		...
		this.caService.setManagedAppliance(appliance, props);
		return appliance;
	}
	...
	public void modifiedService(ServiceReference sr, Object o) {
		...
		Map props = new ReadOnlyDictionary(sr);
		this.caService.updatedManagedAppliance(appliance, props);
	}

	public void removedService(ServiceReference sr, Object o) {
		IManagedAppliance appliance = (IManagedAppliance) o;
		this.caService.unsetManagedAppliance(appliance);
